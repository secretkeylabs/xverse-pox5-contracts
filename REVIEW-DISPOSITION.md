...
| 7 | Source-license treatment was unresolved | TASK-009's historical `CC0-1.0` package disposition was superseded by an explicit owner direction. The current root license and package metadata consistently declare MIT; adapted-source provenance remains in `NOTICE.md`. | CHG-015 and TASK-014 planning records. |
